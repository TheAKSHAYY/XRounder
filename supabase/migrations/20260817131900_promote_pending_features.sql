-- Promoted from .lovable/*.sql — idempotent, safe to re-run on an already-patched database.

-- ===== 1. Announcements + suspension flag + unit reorder RPC =====
-- =====================================================================
...
-- ===== 2. Extended profile fields + notification prefs =====
...
-- ===== 4. Secure per-question quiz grading RPC =====
