...
export function Pill({ icon, value, label }: { icon: React.ReactNode; value: React.ReactNode; label: string }) {
  return (
...
export function MiniStat({ label, value, tone }: { label: string; value: React.ReactNode; tone: "positive" | "negative" | "muted" }) {
  const toneClass =
